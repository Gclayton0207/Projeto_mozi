...
const final_url = base_url + "/discover/movie?certification_country=BR&sort_by=revenue.dsc&primary_release_date.lte=12311999&" + api + "&language=pt-BR";
const img_url = "https://image.tmdb.org/t/p/w500";
const search_url = base_url + '/search/movie?'+ api + "&language=pt-BR";
        ...
        .then(videoData => {
            ...
            if (videoData) {
                ...
                if (videoData.results.length > 0) {
                    ...
                    overlayContent.innerHTML = `<h1>É dificil achar trailers de filmes antigos &#128532</h1>`
...
form.addEventListener('submit', (e) => {
    ...
    if (searchTerm) {
        alert('busca disponivel somente no perfil Master!')
        getMovies(final_url)
    } else {
        getMovies(final_url)
    }
